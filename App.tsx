...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (storedModel && (storedModel === 'gemini-3-pro-preview' || storedModel === 'gemini-2.5-pro-preview')) {
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="gemini-2.5-pro-preview">Gemini 2.5 Pro (gemini-2.5-pro-preview)</option>
                  </select>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col items-center justify-center mb-12">
          {isComplete ? (
            <button
              onClick={handleReset}
              className="relative px-10 py-4 rounded-xl font-bold text-lg shadow-xl transition-all transform bg-emerald-500 text-white hover:bg-emerald-600 hover:shadow-emerald-500/30 hover:-translate-y-1 active:translate-y-0 active:scale-95"
            >
